...
#include "hal/lpc1114/headers/core_cmInstr.h"                /*!< Core Instruction Access                         */
#include "hal/lpc1114/headers/core_cmFunc.h"                 /*!< Core Function Access                            */
...
static __INLINE uint32_t NVIC_GetPriority(IRQn_Type IRQn)
{
  ...
  if(IRQn < 0) {
    ...
    return 0xFF & ((uint32_t)((NVIC->IPR[ _IP_IDX(IRQn)] >> _BIT_SHIFT(IRQn) ) >> (8 - __NVIC_PRIO_BITS)));  } /* get priority for device specific interrupts  */
}
